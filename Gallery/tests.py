...
class TestImage(TestCase):
  ...
  def test_filterlocation(self):
    self.image.save_image()
    self.location2 = Location.objects.create(location='Newyork')
...
class TestLocation(TestCase):
  ...
  def test_deleteLocation(self):
    self.location.saveLocation()
    self.location2 = Location.objects.create(location='Ghana')
  ...
  def test_updateLocation(self):
    ...
    self.assertEqual(updated_one.location, 'Ghana')
